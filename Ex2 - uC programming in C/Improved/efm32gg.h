#ifndef EFM32GG_H	//Statement to be sure this header file cannot be called more than once
#define EFM32GG_H
...
#define PI 				3.141592
#define	CPU_CLOCK		14000	// Frequencies in kHz (to work with smaller variables)
#define SAMPLING_RATE	44.1
#define SAMPLING_PERIOD	950
#define PERIOD_MAX		1150
#define PERIOD_MIN		750
...
#define GPIO_PA_BASE 0x40006000		// Complete addresses
#define GPIO_PB_BASE 0x40006024
#define GPIO_PC_BASE 0x40006048

#define GPIO_PA_CTRL     ((volatile uint32_t*)(GPIO_PA_BASE + 0x00))	// Relative addresses,
#define GPIO_PA_MODEL    ((volatile uint32_t*)(GPIO_PA_BASE + 0x04))	// adding on the complete ones
...
#define CMU2_HFPERCLKEN0_DAC0   (1 << 17)	// Bit position to activate specific peripheral clock
